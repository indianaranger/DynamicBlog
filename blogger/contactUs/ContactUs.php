    ...
    <div class="content">
      <div class="left-side">
        <div class="address details">
          ...
          <div class="text-one">St. Joseph's College of Enginnering and Technology</div>
          <div class="text-two">Palai</div>
        </div>
        <div class="phone details">
          <i class="fas fa-phone-alt"></i>
          <div class="topic">Phone</div>
          <div class="text-one">+919605643245</div>
          <div class="text-two">+919961698747</div>
        </div>
        <div class="email details">
          <i class="fas fa-envelope"></i>
          <div class="topic">Email</div>
          <div class="text-one">ajaycyriac581@gmail.com</div>
          <div class="text-two">edwinrajesh009@gmail.com</div>
        </div>
      </div>
